      ...
      <div className="max-w-4xl mx-auto p-8">
        <div className="text-center">
          ...
          <div className="space-y-4">
            <button className="bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 block mx-auto">
              Entrar como Cliente
            </button>
            <button className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 block mx-auto">
              Entrar como Staff
            </button>
          </div>
